...
public class ExampleQueriesDialog extends Stage {

    public ExampleQueriesDialog() {
        setTitle("Consultas de Exemplo");
        getIcons().add(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/database_icon.png"))));
